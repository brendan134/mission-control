...
**Energy/State:** Tired, apologetic, focused on fixing issues
**Tags:** #operations #systems #team #marketing #quality-control
...
### 1. EPS Logo Files
- Quality issues with vector files
- Need original from Lana
- Kriz to add "Central Coast" text to logo

### 2. Team Communication
- Dom not checking work before sending to Brendan
- Need better handover process between team members
...
- Enrollment week in Philippines
- Dominic caring for daughter

## Action Items
- [ ] Get original vector file from Lana
- [ ] Kriz to add "Central Coast" text to logo
- [ ] Dominic to check work before sending to Brendan
- [ ] Resume Thursday Toolbox posts

## Key Quotes
> "I really apologize if there are some inconvenience going on at this moment"

> "I really couldn't proceed and continue with that"

> "These kind of rough edges sometimes really do happen"

## Coaching Approach
- Addressed frustrations
