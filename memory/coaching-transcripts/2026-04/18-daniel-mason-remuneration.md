...
**Date:** April 4, 2026
**Duration:** ~1h 23m
**Call Type:** Strategy/Operations Coaching
**Energy/State:** Focused, slightly overwhelmed, analytical
**Tags:** #finance #hr #strategy #operations #remuneration

## Client
Daniel Mason - Real Estate Agency

## Key Topics

### 1. AI Frustration
- "It's outright making stuff up"
- Research prompts not working well

### 2. Remuneration Structure Overhaul
- New model: base salary + commission after hitting 2x base
- Projected GP: 19.75% → 18.23% after commissions

### 3. Risk Concern
- "If we don't hit performance... we could end up barely profitable"

### 4. Team Dynamics
- People away (Mel, Emily, Craig) creating workload pressure

### 5. Rollout Approach
- Team meeting vs department-by-department
- Fuel relief top-up idea ($50/week temporary)

### 6. Property Management
- Portfolio redistribution challenges
...
## Action Items
- [ ] Final meeting with Chris and Shel to confirm remuneration structure
- [ ] Create 1-2 page policy document
- [ ] Plan rollout communication (team meeting then department-specific)
- [ ] Stress test scenarios
- [ ] Follow up on profit-sharing pool concept
...
## Coaching Approach
- Advised on rollout approach
- Suggested team meeting first then department-specific
- Recommended stress testing scenarios

## Content Potential
- **Remuneration structures** - Podcast
- **Rolling out new compensation plans** - Email
