...
const teamMembers: TeamMember[] = [
  ...
  { id: 'ian', name: 'Ian', role: 'Head of Growth (BD Agent)', tier: 'B', model: 'kimi', reportsTo: 'strategy', responsibilities: ['Generate new High-Impact Growth Community members', 'Lead identification and outreach', 'Email and LinkedIn campaigns', 'Pipeline management', 'Follow-up sequences', 'Referral partner cultivation'] },
  ...
  { id: 'community', name: 'Lawrie', role: 'Community Manager', tier: 'C', model: 'flashlite', reportsTo: 'client-delivery', responsibilities: ['Community engagement', 'Member support', 'Event coordination'] },
