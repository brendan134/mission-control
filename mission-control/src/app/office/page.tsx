...
const agents: Agent[] = [
  ...
  { id: 'newsletter', name: 'Newsletter Producer', role: 'Newsletter Writer', tier: 'C', status: 'idle', currentTask: 'Waiting for newsletter request', avatar: '📰', location: 'Content Studio' },
  { id: 'linkedin', name: 'LinkedIn Writer', role: 'LinkedIn Content Strategist', tier: 'C', status: 'idle', currentTask: 'Waiting for post request', avatar: '💼', location: 'Content Studio' },
  { id: 'video', name: 'Video Producer', role: 'Video Script Writer', tier: 'C', status: 'idle', currentTask: 'Waiting for video request', avatar: '🎬', location: 'Content Studio' },
  { id: 'email-sequence', name: 'Email Sequence Producer', role: 'Email Sequence Strategist', tier: 'C', status: 'idle', currentTask: 'Waiting for sequence request', avatar: '📧', location: 'Copy Desk' },
